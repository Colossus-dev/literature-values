        ...
        <div className="fade-in">
            ...
            <section
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        { icon: '📘', title: 'Шығармалар', desc: 'Қобыланды, Қыз Жібек, Абай шығармалары жинақталған.' },
            ...
            <section
                ...
                <div className="max-w-md mx-auto bg-white border-2 border-yellow-400 p-8 rounded-3xl shadow-xl text-center mb-20 animate-fade-in-up">
                    ...
                    <p className="mt-4 text-sm text-gray-500 italic">
                        Абай атындағы Қазақ ұлттық педагогикалық университетінің Магистратура және PhD докторантура институтының доценті, педагогика ғылымдарының кандидаты.                    </p>
                </div>
