            ...
            <section
                ...
                <div className="max-w-md mx-auto bg-white border-2 border-yellow-400 p-8 rounded-3xl shadow-xl text-center mb-20 animate-fade-in-up">
                    ...
                    <p className="mt-4 text-sm text-gray-500 italic">
                        ...
                        Абай атындағы Қазақ ұлттық педагогикалық университетінің доценті, педагогика ғылымдарының кандидаты, «Әдебиеттік оқу» кітабының жетекші авторы.</p>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-8 mb-10">
                    {[
                        ...
                        },
                        {
                            ...
                            role: '«Қазақстан халқына» білім беру грантының иегері, «Білімнің жұлдызы» шәкіртқасының иегері. Абай атындағы Қазақ ұлттық педагогикалық университетінің 4-курс студенті',
